...
class IntegrationConfig extends Model
{
    ...
    public const FIELDS = [
        'meta_app' => [
            ...
            ['key' => 'config_id_social',    'label' => 'Embedded Signup Config ID (Instagram / Messenger)', 'type' => 'text', 'required' => false, 'hint' => 'From Meta App Dashboard → Facebook Login for Business → Instagram / Messenger configuration'],
        ],
        'oauth_linkedin' => [
