...
class WhatsappEmbeddedSignupController extends Controller
{
    public function store(Request $request): JsonResponse
    {
        ...
        // Note: For codes generated by the JS SDK (FB.login), the redirect_uri must be an empty string,
        // otherwise Facebook will throw "redirect_uri is not identical" error.
        $tokenParams = [
        ...
        // Fallback: If empty string fails, try the app URL as redirect_uri just in case.
