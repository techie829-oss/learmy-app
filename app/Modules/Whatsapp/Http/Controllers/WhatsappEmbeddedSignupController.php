...
class WhatsappEmbeddedSignupController extends Controller
{
    public function store(Request $request): JsonResponse
    {
        ...
        // Note: For codes generated by the JS SDK (FB.login), the redirect_uri must match the URL where the SDK was invoked.
        // We now receive this from the frontend. If not provided, default to empty string.
        $tokenParams = [
        ...
        // Do NOT pass redirect_uri at all. For Facebook Login JS SDK (FB.login)
        // the code is generated for an internal Meta XD Arbiter URL.
        // Sending ANY redirect_uri here (even an empty string) will mismatch and burn the code.
