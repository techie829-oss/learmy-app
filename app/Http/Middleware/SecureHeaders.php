...
class SecureHeaders
{
    ...
    {
        // Allow Vite dev-server sources when not in production OR when APP_DEBUG is on.
        // The second condition handles cases where the PHP server process has a stale APP_ENV
        // value from a previous boot (e.g. after changing .env without restarting).
